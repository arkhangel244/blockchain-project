...
// func (s *HiringContract) QueryHiring(ctx contractapi.TransactionContextInterface, auctionID string) (*Hiring, error) {
...
// func (s *HiringContract) QueryBid(ctx contractapi.TransactionContextInterface, auctionID string, txID string) (*FullBid, error) {
